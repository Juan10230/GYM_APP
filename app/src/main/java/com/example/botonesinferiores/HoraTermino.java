...
public class HoraTermino extends AppCompatActivity {
    // Lista para almacenar objetos Base (datos de entrenamiento)
    List<Base> listaBases;

    // Lista de BarEntry para las horas de termino
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_hora_termino);
    ...
    private void cargarDatosEnGrafica() {
        ...
        for (int i = 0; i < listaBases.size(); i++) {
            // Obtiene la hora de termino de cada registro
            String horaString = listaBases.get(i).horaFinUsuario;
        ...
        BarDataSet barDataSet = new BarDataSet(hora, "Estadísticas de 'Hora de termino'");
